/*
 * imx421.c - imx421 sensor driver mode table
 *
 *
 */
...
#ifndef __IMX421_SPI_TABLES__
#define __IMX421_SPI_TABLES__
...
struct reg_16_8 {
	uint16_t addr;							// change to u16 for chipID + address this was set u32 in IMX204
	uint8_t val;
};
#define imx421_reg struct reg_16_8

static imx421_reg mode_table_common[] = {
	{IMX421_TABLE_END, 0x00},
};

static const imx421_reg imx421_start[] = {
...
static const imx421_reg imx421_stop[] = {
	{0x0200, 0x01},						// make the standby to active mode
	{IMX421_TABLE_WAIT_MS, 7},
	{IMX421_TABLE_END, 0x00},
};

static const imx421_reg tp_colorbars[] = {
	{IMX421_TABLE_END, 0x00},
};
 ...
 * -------------------------------------------------------------------------------------*/
static const imx421_reg mode_3712x1548[] = {
	/*
...
static const imx421_reg mode_sensor_test[] = {
	/*
		CHIP ID 2 related registers
	*/
	{0x0200, 0x00},		// normal operation mode
...
static const imx421_reg *mode_table[] = {
	[IMX421_MODE_3712x1548] = mode_3712x1548,	// YXU: Should this be [IMX421_MODE_3712x1548]?
...
static const int imx421_409_fr[] = {
	409,
};


#endif  /* __IMX421_SPI_TABLES__ */
