// c5_niosii_spi_slvsec_niosii_cpu_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module c5_niosii_spi_slvsec_niosii_cpu_mm_interconnect_0 (
		input  wire        clk_0_clk_clk,                                   //                                 clk_0_clk.clk
		input  wire        nios2_gen2_0_reset_reset_bridge_in_reset_reset,  //  nios2_gen2_0_reset_reset_bridge_in_reset.reset
		input  wire        spi_mm_bridge_reset_reset_bridge_in_reset_reset, // spi_mm_bridge_reset_reset_bridge_in_reset.reset
		...
		output wire [9:0]  spi_mm_bridge_s0_address,                        //                          spi_mm_bridge_s0.address
		output wire        spi_mm_bridge_s0_write,                          //                                          .write
		output wire        spi_mm_bridge_s0_read,                           //                                          .read
		input  wire [31:0] spi_mm_bridge_s0_readdata,                       //                                          .readdata
		output wire [31:0] spi_mm_bridge_s0_writedata,                      //                                          .writedata
		output wire [0:0]  spi_mm_bridge_s0_burstcount,                     //                                          .burstcount
		output wire [3:0]  spi_mm_bridge_s0_byteenable,                     //                                          .byteenable
		input  wire        spi_mm_bridge_s0_readdatavalid,                  //                                          .readdatavalid
		input  wire        spi_mm_bridge_s0_waitrequest,                    //                                          .waitrequest
		output wire        spi_mm_bridge_s0_debugaccess,                    //                                          .debugaccess
		...
		output wire [9:0]  xtrig_mm_bridge_s0_address,                      //                        xtrig_mm_bridge_s0.address
		output wire        xtrig_mm_bridge_s0_write,                        //                                          .write
		output wire        xtrig_mm_bridge_s0_read,                         //                                          .read
		input  wire [31:0] xtrig_mm_bridge_s0_readdata,                     //                                          .readdata
		output wire [31:0] xtrig_mm_bridge_s0_writedata,                    //                                          .writedata
		output wire [0:0]  xtrig_mm_bridge_s0_burstcount,                   //                                          .burstcount
		output wire [3:0]  xtrig_mm_bridge_s0_byteenable,                   //                                          .byteenable
		input  wire        xtrig_mm_bridge_s0_readdatavalid,                //                                          .readdatavalid
		input  wire        xtrig_mm_bridge_s0_waitrequest,                  //                                          .waitrequest
		output wire        xtrig_mm_bridge_s0_debugaccess                   //                                          .debugaccess
	);
	...
	wire  [31:0] spi_mm_bridge_s0_agent_m0_readdata;                                                 // spi_mm_bridge_s0_translator:uav_readdata -> spi_mm_bridge_s0_agent:m0_readdata
	wire         spi_mm_bridge_s0_agent_m0_waitrequest;                                              // spi_mm_bridge_s0_translator:uav_waitrequest -> spi_mm_bridge_s0_agent:m0_waitrequest
	wire         spi_mm_bridge_s0_agent_m0_debugaccess;                                              // spi_mm_bridge_s0_agent:m0_debugaccess -> spi_mm_bridge_s0_translator:uav_debugaccess
	wire  [18:0] spi_mm_bridge_s0_agent_m0_address;                                                  // spi_mm_bridge_s0_agent:m0_address -> spi_mm_bridge_s0_translator:uav_address
	wire   [3:0] spi_mm_bridge_s0_agent_m0_byteenable;                                               // spi_mm_bridge_s0_agent:m0_byteenable -> spi_mm_bridge_s0_translator:uav_byteenable
	wire         spi_mm_bridge_s0_agent_m0_read;                                                     // spi_mm_bridge_s0_agent:m0_read -> spi_mm_bridge_s0_translator:uav_read
	wire         spi_mm_bridge_s0_agent_m0_readdatavalid;                                            // spi_mm_bridge_s0_translator:uav_readdatavalid -> spi_mm_bridge_s0_agent:m0_readdatavalid
	wire         spi_mm_bridge_s0_agent_m0_lock;                                                     // spi_mm_bridge_s0_agent:m0_lock -> spi_mm_bridge_s0_translator:uav_lock
	wire  [31:0] spi_mm_bridge_s0_agent_m0_writedata;                                                // spi_mm_bridge_s0_agent:m0_writedata -> spi_mm_bridge_s0_translator:uav_writedata
	wire         spi_mm_bridge_s0_agent_m0_write;                                                    // spi_mm_bridge_s0_agent:m0_write -> spi_mm_bridge_s0_translator:uav_write
	wire   [2:0] spi_mm_bridge_s0_agent_m0_burstcount;                                               // spi_mm_bridge_s0_agent:m0_burstcount -> spi_mm_bridge_s0_translator:uav_burstcount
	wire         spi_mm_bridge_s0_agent_rf_source_valid;                                             // spi_mm_bridge_s0_agent:rf_source_valid -> spi_mm_bridge_s0_agent_rsp_fifo:in_valid
	wire  [97:0] spi_mm_bridge_s0_agent_rf_source_data;                                              // spi_mm_bridge_s0_agent:rf_source_data -> spi_mm_bridge_s0_agent_rsp_fifo:in_data
	wire         spi_mm_bridge_s0_agent_rf_source_ready;                                             // spi_mm_bridge_s0_agent_rsp_fifo:in_ready -> spi_mm_bridge_s0_agent:rf_source_ready
	wire         spi_mm_bridge_s0_agent_rf_source_startofpacket;                                     // spi_mm_bridge_s0_agent:rf_source_startofpacket -> spi_mm_bridge_s0_agent_rsp_fifo:in_startofpacket
	wire         spi_mm_bridge_s0_agent_rf_source_endofpacket;                                       // spi_mm_bridge_s0_agent:rf_source_endofpacket -> spi_mm_bridge_s0_agent_rsp_fifo:in_endofpacket
	wire         spi_mm_bridge_s0_agent_rsp_fifo_out_valid;                                          // spi_mm_bridge_s0_agent_rsp_fifo:out_valid -> spi_mm_bridge_s0_agent:rf_sink_valid
	wire  [97:0] spi_mm_bridge_s0_agent_rsp_fifo_out_data;                                           // spi_mm_bridge_s0_agent_rsp_fifo:out_data -> spi_mm_bridge_s0_agent:rf_sink_data
	wire         spi_mm_bridge_s0_agent_rsp_fifo_out_ready;                                          // spi_mm_bridge_s0_agent:rf_sink_ready -> spi_mm_bridge_s0_agent_rsp_fifo:out_ready
	wire         spi_mm_bridge_s0_agent_rsp_fifo_out_startofpacket;                                  // spi_mm_bridge_s0_agent_rsp_fifo:out_startofpacket -> spi_mm_bridge_s0_agent:rf_sink_startofpacket
	wire         spi_mm_bridge_s0_agent_rsp_fifo_out_endofpacket;                                    // spi_mm_bridge_s0_agent_rsp_fifo:out_endofpacket -> spi_mm_bridge_s0_agent:rf_sink_endofpacket
	wire         cmd_mux_003_src_valid;                                                              // cmd_mux_003:src_valid -> spi_mm_bridge_s0_agent:cp_valid
	wire  [96:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> spi_mm_bridge_s0_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                              // spi_mm_bridge_s0_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [9:0] cmd_mux_003_src_channel;                                                            // cmd_mux_003:src_channel -> spi_mm_bridge_s0_agent:cp_channel
	wire         cmd_mux_003_src_startofpacket;                                                      // cmd_mux_003:src_startofpacket -> spi_mm_bridge_s0_agent:cp_startofpacket
	wire         cmd_mux_003_src_endofpacket;                                                        // cmd_mux_003:src_endofpacket -> spi_mm_bridge_s0_agent:cp_endofpacket
	wire  [31:0] xtrig_mm_bridge_s0_agent_m0_readdata;                                               // xtrig_mm_bridge_s0_translator:uav_readdata -> xtrig_mm_bridge_s0_agent:m0_readdata
	wire         xtrig_mm_bridge_s0_agent_m0_waitrequest;                                            // xtrig_mm_bridge_s0_translator:uav_waitrequest -> xtrig_mm_bridge_s0_agent:m0_waitrequest
	wire         xtrig_mm_bridge_s0_agent_m0_debugaccess;                                            // xtrig_mm_bridge_s0_agent:m0_debugaccess -> xtrig_mm_bridge_s0_translator:uav_debugaccess
	wire  [18:0] xtrig_mm_bridge_s0_agent_m0_address;                                                // xtrig_mm_bridge_s0_agent:m0_address -> xtrig_mm_bridge_s0_translator:uav_address
	wire   [3:0] xtrig_mm_bridge_s0_agent_m0_byteenable;                                             // xtrig_mm_bridge_s0_agent:m0_byteenable -> xtrig_mm_bridge_s0_translator:uav_byteenable
	wire         xtrig_mm_bridge_s0_agent_m0_read;                                                   // xtrig_mm_bridge_s0_agent:m0_read -> xtrig_mm_bridge_s0_translator:uav_read
	wire         xtrig_mm_bridge_s0_agent_m0_readdatavalid;                                          // xtrig_mm_bridge_s0_translator:uav_readdatavalid -> xtrig_mm_bridge_s0_agent:m0_readdatavalid
	wire         xtrig_mm_bridge_s0_agent_m0_lock;                                                   // xtrig_mm_bridge_s0_agent:m0_lock -> xtrig_mm_bridge_s0_translator:uav_lock
	wire  [31:0] xtrig_mm_bridge_s0_agent_m0_writedata;                                              // xtrig_mm_bridge_s0_agent:m0_writedata -> xtrig_mm_bridge_s0_translator:uav_writedata
	wire         xtrig_mm_bridge_s0_agent_m0_write;                                                  // xtrig_mm_bridge_s0_agent:m0_write -> xtrig_mm_bridge_s0_translator:uav_write
	wire   [2:0] xtrig_mm_bridge_s0_agent_m0_burstcount;                                             // xtrig_mm_bridge_s0_agent:m0_burstcount -> xtrig_mm_bridge_s0_translator:uav_burstcount
	wire         xtrig_mm_bridge_s0_agent_rf_source_valid;                                           // xtrig_mm_bridge_s0_agent:rf_source_valid -> xtrig_mm_bridge_s0_agent_rsp_fifo:in_valid
	wire  [97:0] xtrig_mm_bridge_s0_agent_rf_source_data;                                            // xtrig_mm_bridge_s0_agent:rf_source_data -> xtrig_mm_bridge_s0_agent_rsp_fifo:in_data
	wire         xtrig_mm_bridge_s0_agent_rf_source_ready;                                           // xtrig_mm_bridge_s0_agent_rsp_fifo:in_ready -> xtrig_mm_bridge_s0_agent:rf_source_ready
	wire         xtrig_mm_bridge_s0_agent_rf_source_startofpacket;                                   // xtrig_mm_bridge_s0_agent:rf_source_startofpacket -> xtrig_mm_bridge_s0_agent_rsp_fifo:in_startofpacket
	wire         xtrig_mm_bridge_s0_agent_rf_source_endofpacket;                                     // xtrig_mm_bridge_s0_agent:rf_source_endofpacket -> xtrig_mm_bridge_s0_agent_rsp_fifo:in_endofpacket
	wire         xtrig_mm_bridge_s0_agent_rsp_fifo_out_valid;                                        // xtrig_mm_bridge_s0_agent_rsp_fifo:out_valid -> xtrig_mm_bridge_s0_agent:rf_sink_valid
	wire  [97:0] xtrig_mm_bridge_s0_agent_rsp_fifo_out_data;                                         // xtrig_mm_bridge_s0_agent_rsp_fifo:out_data -> xtrig_mm_bridge_s0_agent:rf_sink_data
	wire         xtrig_mm_bridge_s0_agent_rsp_fifo_out_ready;                                        // xtrig_mm_bridge_s0_agent:rf_sink_ready -> xtrig_mm_bridge_s0_agent_rsp_fifo:out_ready
	wire         xtrig_mm_bridge_s0_agent_rsp_fifo_out_startofpacket;                                // xtrig_mm_bridge_s0_agent_rsp_fifo:out_startofpacket -> xtrig_mm_bridge_s0_agent:rf_sink_startofpacket
	wire         xtrig_mm_bridge_s0_agent_rsp_fifo_out_endofpacket;                                  // xtrig_mm_bridge_s0_agent_rsp_fifo:out_endofpacket -> xtrig_mm_bridge_s0_agent:rf_sink_endofpacket
	wire         cmd_mux_004_src_valid;                                                              // cmd_mux_004:src_valid -> xtrig_mm_bridge_s0_agent:cp_valid
	wire  [96:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> xtrig_mm_bridge_s0_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                              // xtrig_mm_bridge_s0_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [9:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> xtrig_mm_bridge_s0_agent:cp_channel
	wire         cmd_mux_004_src_startofpacket;                                                      // cmd_mux_004:src_startofpacket -> xtrig_mm_bridge_s0_agent:cp_startofpacket
	wire         cmd_mux_004_src_endofpacket;                                                        // cmd_mux_004:src_endofpacket -> xtrig_mm_bridge_s0_agent:cp_endofpacket
	...
	wire  [96:0] cmd_mux_008_src_data;                                                               // cmd_mux_008:src_data -> sw_s1_agent:cp_data
	wire         cmd_mux_008_src_ready;                                                              // sw_s1_agent:cp_ready -> cmd_mux_008:src_ready
	wire   [9:0] cmd_mux_008_src_channel;                                                            // cmd_mux_008:src_channel -> sw_s1_agent:cp_channel
	...
	wire         spi_mm_bridge_s0_agent_rp_valid;                                                    // spi_mm_bridge_s0_agent:rp_valid -> router_005:sink_valid
	wire  [96:0] spi_mm_bridge_s0_agent_rp_data;                                                     // spi_mm_bridge_s0_agent:rp_data -> router_005:sink_data
	wire         spi_mm_bridge_s0_agent_rp_ready;                                                    // router_005:sink_ready -> spi_mm_bridge_s0_agent:rp_ready
	wire         spi_mm_bridge_s0_agent_rp_startofpacket;                                            // spi_mm_bridge_s0_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire         spi_mm_bridge_s0_agent_rp_endofpacket;                                              // spi_mm_bridge_s0_agent:rp_endofpacket -> router_005:sink_endofpacket
	...
	wire         xtrig_mm_bridge_s0_agent_rp_valid;                                                  // xtrig_mm_bridge_s0_agent:rp_valid -> router_006:sink_valid
	wire  [96:0] xtrig_mm_bridge_s0_agent_rp_data;                                                   // xtrig_mm_bridge_s0_agent:rp_data -> router_006:sink_data
	wire         xtrig_mm_bridge_s0_agent_rp_ready;                                                  // router_006:sink_ready -> xtrig_mm_bridge_s0_agent:rp_ready
	wire         xtrig_mm_bridge_s0_agent_rp_startofpacket;                                          // xtrig_mm_bridge_s0_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire         xtrig_mm_bridge_s0_agent_rp_endofpacket;                                            // xtrig_mm_bridge_s0_agent:rp_endofpacket -> router_006:sink_endofpacket
	...
	wire  [96:0] sw_s1_agent_rp_data;                                                                // sw_s1_agent:rp_data -> router_010:sink_data
	...
	wire         spi_mm_bridge_s0_agent_rdata_fifo_src_valid;                                        // spi_mm_bridge_s0_agent:rdata_fifo_src_valid -> avalon_st_adapter_003:in_0_valid
	wire  [33:0] spi_mm_bridge_s0_agent_rdata_fifo_src_data;                                         // spi_mm_bridge_s0_agent:rdata_fifo_src_data -> avalon_st_adapter_003:in_0_data
	wire         spi_mm_bridge_s0_agent_rdata_fifo_src_ready;                                        // avalon_st_adapter_003:in_0_ready -> spi_mm_bridge_s0_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_003_out_0_valid;                                                  // avalon_st_adapter_003:out_0_valid -> spi_mm_bridge_s0_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_003_out_0_data;                                                   // avalon_st_adapter_003:out_0_data -> spi_mm_bridge_s0_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_003_out_0_ready;                                                  // spi_mm_bridge_s0_agent:rdata_fifo_sink_ready -> avalon_st_adapter_003:out_0_ready
	wire   [0:0] avalon_st_adapter_003_out_0_error;                                                  // avalon_st_adapter_003:out_0_error -> spi_mm_bridge_s0_agent:rdata_fifo_sink_error
	wire         xtrig_mm_bridge_s0_agent_rdata_fifo_src_valid;                                      // xtrig_mm_bridge_s0_agent:rdata_fifo_src_valid -> avalon_st_adapter_004:in_0_valid
	wire  [33:0] xtrig_mm_bridge_s0_agent_rdata_fifo_src_data;                                       // xtrig_mm_bridge_s0_agent:rdata_fifo_src_data -> avalon_st_adapter_004:in_0_data
	wire         xtrig_mm_bridge_s0_agent_rdata_fifo_src_ready;                                      // avalon_st_adapter_004:in_0_ready -> xtrig_mm_bridge_s0_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_004_out_0_valid;                                                  // avalon_st_adapter_004:out_0_valid -> xtrig_mm_bridge_s0_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_004_out_0_data;                                                   // avalon_st_adapter_004:out_0_data -> xtrig_mm_bridge_s0_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_004_out_0_ready;                                                  // xtrig_mm_bridge_s0_agent:rdata_fifo_sink_ready -> avalon_st_adapter_004:out_0_ready
	wire   [0:0] avalon_st_adapter_004_out_0_error;                                                  // avalon_st_adapter_004:out_0_error -> xtrig_mm_bridge_s0_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) spi_mm_bridge_s0_translator (
		.clk                    (clk_0_clk_clk),                                   //                      clk.clk
		.reset                  (spi_mm_bridge_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (spi_mm_bridge_s0_agent_m0_address),               // avalon_universal_slave_0.address
		.uav_burstcount         (spi_mm_bridge_s0_agent_m0_burstcount),            //                         .burstcount
		.uav_read               (spi_mm_bridge_s0_agent_m0_read),                  //                         .read
		.uav_write              (spi_mm_bridge_s0_agent_m0_write),                 //                         .write
		.uav_waitrequest        (spi_mm_bridge_s0_agent_m0_waitrequest),           //                         .waitrequest
		.uav_readdatavalid      (spi_mm_bridge_s0_agent_m0_readdatavalid),         //                         .readdatavalid
		.uav_byteenable         (spi_mm_bridge_s0_agent_m0_byteenable),            //                         .byteenable
		.uav_readdata           (spi_mm_bridge_s0_agent_m0_readdata),              //                         .readdata
		.uav_writedata          (spi_mm_bridge_s0_agent_m0_writedata),             //                         .writedata
		.uav_lock               (spi_mm_bridge_s0_agent_m0_lock),                  //                         .lock
		.uav_debugaccess        (spi_mm_bridge_s0_agent_m0_debugaccess),           //                         .debugaccess
		.av_address             (spi_mm_bridge_s0_address),                        //      avalon_anti_slave_0.address
		.av_write               (spi_mm_bridge_s0_write),                          //                         .write
		.av_read                (spi_mm_bridge_s0_read),                           //                         .read
		.av_readdata            (spi_mm_bridge_s0_readdata),                       //                         .readdata
		.av_writedata           (spi_mm_bridge_s0_writedata),                      //                         .writedata
		.av_burstcount          (spi_mm_bridge_s0_burstcount),                     //                         .burstcount
		.av_byteenable          (spi_mm_bridge_s0_byteenable),                     //                         .byteenable
		.av_readdatavalid       (spi_mm_bridge_s0_readdatavalid),                  //                         .readdatavalid
		.av_waitrequest         (spi_mm_bridge_s0_waitrequest),                    //                         .waitrequest
		.av_debugaccess         (spi_mm_bridge_s0_debugaccess),                    //                         .debugaccess
		.av_begintransfer       (),                                                //              (terminated)
		.av_beginbursttransfer  (),                                                //              (terminated)
		.av_writebyteenable     (),                                                //              (terminated)
		.av_lock                (),                                                //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) xtrig_mm_bridge_s0_translator (
		.clk                    (clk_0_clk_clk),                                   //                      clk.clk
		.reset                  (spi_mm_bridge_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (xtrig_mm_bridge_s0_agent_m0_address),             // avalon_universal_slave_0.address
		.uav_burstcount         (xtrig_mm_bridge_s0_agent_m0_burstcount),          //                         .burstcount
		.uav_read               (xtrig_mm_bridge_s0_agent_m0_read),                //                         .read
		.uav_write              (xtrig_mm_bridge_s0_agent_m0_write),               //                         .write
		.uav_waitrequest        (xtrig_mm_bridge_s0_agent_m0_waitrequest),         //                         .waitrequest
		.uav_readdatavalid      (xtrig_mm_bridge_s0_agent_m0_readdatavalid),       //                         .readdatavalid
		.uav_byteenable         (xtrig_mm_bridge_s0_agent_m0_byteenable),          //                         .byteenable
		.uav_readdata           (xtrig_mm_bridge_s0_agent_m0_readdata),            //                         .readdata
		.uav_writedata          (xtrig_mm_bridge_s0_agent_m0_writedata),           //                         .writedata
		.uav_lock               (xtrig_mm_bridge_s0_agent_m0_lock),                //                         .lock
		.uav_debugaccess        (xtrig_mm_bridge_s0_agent_m0_debugaccess),         //                         .debugaccess
		.av_address             (xtrig_mm_bridge_s0_address),                      //      avalon_anti_slave_0.address
		.av_write               (xtrig_mm_bridge_s0_write),                        //                         .write
		.av_read                (xtrig_mm_bridge_s0_read),                         //                         .read
		.av_readdata            (xtrig_mm_bridge_s0_readdata),                     //                         .readdata
		.av_writedata           (xtrig_mm_bridge_s0_writedata),                    //                         .writedata
		.av_burstcount          (xtrig_mm_bridge_s0_burstcount),                   //                         .burstcount
		.av_byteenable          (xtrig_mm_bridge_s0_byteenable),                   //                         .byteenable
		.av_readdatavalid       (xtrig_mm_bridge_s0_readdatavalid),                //                         .readdatavalid
		.av_waitrequest         (xtrig_mm_bridge_s0_waitrequest),                  //                         .waitrequest
		.av_debugaccess         (xtrig_mm_bridge_s0_debugaccess),                  //                         .debugaccess
		.av_begintransfer       (),                                                //              (terminated)
		.av_beginbursttransfer  (),                                                //              (terminated)
		.av_writebyteenable     (),                                                //              (terminated)
		.av_lock                (),                                                //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) spi_mm_bridge_s0_agent (
		.clk                     (clk_0_clk_clk),                                     //             clk.clk
		.reset                   (spi_mm_bridge_reset_reset_bridge_in_reset_reset),   //       clk_reset.reset
		.m0_address              (spi_mm_bridge_s0_agent_m0_address),                 //              m0.address
		.m0_burstcount           (spi_mm_bridge_s0_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (spi_mm_bridge_s0_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (spi_mm_bridge_s0_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (spi_mm_bridge_s0_agent_m0_lock),                    //                .lock
		.m0_readdata             (spi_mm_bridge_s0_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (spi_mm_bridge_s0_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (spi_mm_bridge_s0_agent_m0_read),                    //                .read
		.m0_waitrequest          (spi_mm_bridge_s0_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (spi_mm_bridge_s0_agent_m0_writedata),               //                .writedata
		.m0_write                (spi_mm_bridge_s0_agent_m0_write),                   //                .write
		.rp_endofpacket          (spi_mm_bridge_s0_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (spi_mm_bridge_s0_agent_rp_ready),                   //                .ready
		.rp_valid                (spi_mm_bridge_s0_agent_rp_valid),                   //                .valid
		.rp_data                 (spi_mm_bridge_s0_agent_rp_data),                    //                .data
		.rp_startofpacket        (spi_mm_bridge_s0_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (spi_mm_bridge_s0_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (spi_mm_bridge_s0_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (spi_mm_bridge_s0_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (spi_mm_bridge_s0_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (spi_mm_bridge_s0_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (spi_mm_bridge_s0_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (spi_mm_bridge_s0_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (spi_mm_bridge_s0_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (spi_mm_bridge_s0_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (spi_mm_bridge_s0_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_003_out_0_ready),                 // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_003_out_0_valid),                 //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_003_out_0_data),                  //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_003_out_0_error),                 //                .error
		.rdata_fifo_src_ready    (spi_mm_bridge_s0_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (spi_mm_bridge_s0_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (spi_mm_bridge_s0_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                             //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                               //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) spi_mm_bridge_s0_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                     //       clk.clk
		.reset             (spi_mm_bridge_reset_reset_bridge_in_reset_reset),   // clk_reset.reset
		.in_data           (spi_mm_bridge_s0_agent_rf_source_data),             //        in.data
		.in_valid          (spi_mm_bridge_s0_agent_rf_source_valid),            //          .valid
		.in_ready          (spi_mm_bridge_s0_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (spi_mm_bridge_s0_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (spi_mm_bridge_s0_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (spi_mm_bridge_s0_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (spi_mm_bridge_s0_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (spi_mm_bridge_s0_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (spi_mm_bridge_s0_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (spi_mm_bridge_s0_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                             // (terminated)
		.csr_read          (1'b0),                                              // (terminated)
		.csr_write         (1'b0),                                              // (terminated)
		.csr_readdata      (),                                                  // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) xtrig_mm_bridge_s0_agent (
		.clk                     (clk_0_clk_clk),                                       //             clk.clk
		.reset                   (spi_mm_bridge_reset_reset_bridge_in_reset_reset),     //       clk_reset.reset
		.m0_address              (xtrig_mm_bridge_s0_agent_m0_address),                 //              m0.address
		.m0_burstcount           (xtrig_mm_bridge_s0_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (xtrig_mm_bridge_s0_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (xtrig_mm_bridge_s0_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (xtrig_mm_bridge_s0_agent_m0_lock),                    //                .lock
		.m0_readdata             (xtrig_mm_bridge_s0_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (xtrig_mm_bridge_s0_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (xtrig_mm_bridge_s0_agent_m0_read),                    //                .read
		.m0_waitrequest          (xtrig_mm_bridge_s0_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (xtrig_mm_bridge_s0_agent_m0_writedata),               //                .writedata
		.m0_write                (xtrig_mm_bridge_s0_agent_m0_write),                   //                .write
		.rp_endofpacket          (xtrig_mm_bridge_s0_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (xtrig_mm_bridge_s0_agent_rp_ready),                   //                .ready
		.rp_valid                (xtrig_mm_bridge_s0_agent_rp_valid),                   //                .valid
		.rp_data                 (xtrig_mm_bridge_s0_agent_rp_data),                    //                .data
		.rp_startofpacket        (xtrig_mm_bridge_s0_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (xtrig_mm_bridge_s0_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (xtrig_mm_bridge_s0_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (xtrig_mm_bridge_s0_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (xtrig_mm_bridge_s0_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (xtrig_mm_bridge_s0_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (xtrig_mm_bridge_s0_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (xtrig_mm_bridge_s0_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (xtrig_mm_bridge_s0_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (xtrig_mm_bridge_s0_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (xtrig_mm_bridge_s0_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_004_out_0_ready),                   // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_004_out_0_valid),                   //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_004_out_0_data),                    //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_004_out_0_error),                   //                .error
		.rdata_fifo_src_ready    (xtrig_mm_bridge_s0_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (xtrig_mm_bridge_s0_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (xtrig_mm_bridge_s0_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                               //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                 //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) xtrig_mm_bridge_s0_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                       //       clk.clk
		.reset             (spi_mm_bridge_reset_reset_bridge_in_reset_reset),     // clk_reset.reset
		.in_data           (xtrig_mm_bridge_s0_agent_rf_source_data),             //        in.data
		.in_valid          (xtrig_mm_bridge_s0_agent_rf_source_valid),            //          .valid
		.in_ready          (xtrig_mm_bridge_s0_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (xtrig_mm_bridge_s0_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (xtrig_mm_bridge_s0_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (xtrig_mm_bridge_s0_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (xtrig_mm_bridge_s0_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (xtrig_mm_bridge_s0_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (xtrig_mm_bridge_s0_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (xtrig_mm_bridge_s0_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                               // (terminated)
		.csr_read          (1'b0),                                                // (terminated)
		.csr_write         (1'b0),                                                // (terminated)
		.csr_readdata      (),                                                    // (terminated)
	...
	c5_niosii_spi_slvsec_niosii_cpu_mm_interconnect_0_router router (
	...
	c5_niosii_spi_slvsec_niosii_cpu_mm_interconnect_0_router_001 router_001 (
	...
	c5_niosii_spi_slvsec_niosii_cpu_mm_interconnect_0_router_002 router_002 (
	...
	c5_niosii_spi_slvsec_niosii_cpu_mm_interconnect_0_router_002 router_003 (
	...
	c5_niosii_spi_slvsec_niosii_cpu_mm_interconnect_0_router_004 router_004 (
	...
	c5_niosii_spi_slvsec_niosii_cpu_mm_interconnect_0_router_002 router_005 (
		.sink_ready         (spi_mm_bridge_s0_agent_rp_ready),                 //      sink.ready
		.sink_valid         (spi_mm_bridge_s0_agent_rp_valid),                 //          .valid
		.sink_data          (spi_mm_bridge_s0_agent_rp_data),                  //          .data
		.sink_startofpacket (spi_mm_bridge_s0_agent_rp_startofpacket),         //          .startofpacket
		.sink_endofpacket   (spi_mm_bridge_s0_agent_rp_endofpacket),           //          .endofpacket
		.clk                (clk_0_clk_clk),                                   //       clk.clk
		.reset              (spi_mm_bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	c5_niosii_spi_slvsec_niosii_cpu_mm_interconnect_0_router_002 router_006 (
		.sink_ready         (xtrig_mm_bridge_s0_agent_rp_ready),               //      sink.ready
		.sink_valid         (xtrig_mm_bridge_s0_agent_rp_valid),               //          .valid
		.sink_data          (xtrig_mm_bridge_s0_agent_rp_data),                //          .data
		.sink_startofpacket (xtrig_mm_bridge_s0_agent_rp_startofpacket),       //          .startofpacket
		.sink_endofpacket   (xtrig_mm_bridge_s0_agent_rp_endofpacket),         //          .endofpacket
		.clk                (clk_0_clk_clk),                                   //       clk.clk
		.reset              (spi_mm_bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	c5_niosii_spi_slvsec_niosii_cpu_mm_interconnect_0_router_004 router_007 (
	...
	c5_niosii_spi_slvsec_niosii_cpu_mm_interconnect_0_router_002 router_008 (
	...
	c5_niosii_spi_slvsec_niosii_cpu_mm_interconnect_0_router_002 router_009 (
	...
	c5_niosii_spi_slvsec_niosii_cpu_mm_interconnect_0_router_002 router_010 (
	...
	c5_niosii_spi_slvsec_niosii_cpu_mm_interconnect_0_router_002 router_011 (
	...
	c5_niosii_spi_slvsec_niosii_cpu_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                          //        clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset),         //  clk_reset.reset
	...
	c5_niosii_spi_slvsec_niosii_cpu_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (clk_0_clk_clk),                                                 //        clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset),                //  clk_reset.reset
	...
	c5_niosii_spi_slvsec_niosii_cpu_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	c5_niosii_spi_slvsec_niosii_cpu_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	c5_niosii_spi_slvsec_niosii_cpu_mm_interconnect_0_cmd_mux_002 cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	c5_niosii_spi_slvsec_niosii_cpu_mm_interconnect_0_cmd_mux cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                                   //       clk.clk
		.reset               (spi_mm_bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	c5_niosii_spi_slvsec_niosii_cpu_mm_interconnect_0_cmd_mux cmd_mux_004 (
		.clk                 (clk_0_clk_clk),                                   //       clk.clk
		.reset               (spi_mm_bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	c5_niosii_spi_slvsec_niosii_cpu_mm_interconnect_0_cmd_mux_002 cmd_mux_005 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	c5_niosii_spi_slvsec_niosii_cpu_mm_interconnect_0_cmd_mux cmd_mux_006 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	c5_niosii_spi_slvsec_niosii_cpu_mm_interconnect_0_cmd_mux cmd_mux_007 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	c5_niosii_spi_slvsec_niosii_cpu_mm_interconnect_0_cmd_mux cmd_mux_008 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	c5_niosii_spi_slvsec_niosii_cpu_mm_interconnect_0_cmd_mux cmd_mux_009 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	c5_niosii_spi_slvsec_niosii_cpu_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	c5_niosii_spi_slvsec_niosii_cpu_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	c5_niosii_spi_slvsec_niosii_cpu_mm_interconnect_0_rsp_demux_002 rsp_demux_002 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	c5_niosii_spi_slvsec_niosii_cpu_mm_interconnect_0_rsp_demux rsp_demux_003 (
		.clk                (clk_0_clk_clk),                                   //       clk.clk
		.reset              (spi_mm_bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	c5_niosii_spi_slvsec_niosii_cpu_mm_interconnect_0_rsp_demux rsp_demux_004 (
		.clk                (clk_0_clk_clk),                                   //       clk.clk
		.reset              (spi_mm_bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	c5_niosii_spi_slvsec_niosii_cpu_mm_interconnect_0_rsp_demux rsp_demux_006 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	c5_niosii_spi_slvsec_niosii_cpu_mm_interconnect_0_rsp_demux rsp_demux_007 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	c5_niosii_spi_slvsec_niosii_cpu_mm_interconnect_0_rsp_demux rsp_demux_008 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	c5_niosii_spi_slvsec_niosii_cpu_mm_interconnect_0_rsp_demux rsp_demux_009 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	c5_niosii_spi_slvsec_niosii_cpu_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	c5_niosii_spi_slvsec_niosii_cpu_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                   // in_clk_0.clk
		.in_rst_0_reset (spi_mm_bridge_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (spi_mm_bridge_s0_agent_rdata_fifo_src_data),      //     in_0.data
		.in_0_valid     (spi_mm_bridge_s0_agent_rdata_fifo_src_valid),     //         .valid
		.in_0_ready     (spi_mm_bridge_s0_agent_rdata_fifo_src_ready),     //         .ready
	...
	c5_niosii_spi_slvsec_niosii_cpu_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                   // in_clk_0.clk
		.in_rst_0_reset (spi_mm_bridge_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (xtrig_mm_bridge_s0_agent_rdata_fifo_src_data),    //     in_0.data
		.in_0_valid     (xtrig_mm_bridge_s0_agent_rdata_fifo_src_valid),   //         .valid
		.in_0_ready     (xtrig_mm_bridge_s0_agent_rdata_fifo_src_ready),   //         .ready
