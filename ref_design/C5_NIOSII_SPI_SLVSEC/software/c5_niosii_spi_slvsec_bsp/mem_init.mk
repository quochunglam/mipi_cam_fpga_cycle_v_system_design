...
# Memory: niosii_cpu_onchip_memory2_0
MEM_0 := c5_niosii_spi_slvsec_niosii_cpu_onchip_memory2_0
$(MEM_0)_NAME := niosii_cpu_onchip_memory2_0
...
$(MEM_0)_HIERARCHICAL_PATH := niosii_cpu.onchip_memory2_0
$(MEM_0)_WIDTH := 32
$(MEM_0)_HEX_DATA_WIDTH := 32
$(MEM_0)_ENDIANNESS := --little-endian-mem
$(MEM_0)_CREATE_LANES := 0

.PHONY: niosii_cpu_onchip_memory2_0
niosii_cpu_onchip_memory2_0: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym
