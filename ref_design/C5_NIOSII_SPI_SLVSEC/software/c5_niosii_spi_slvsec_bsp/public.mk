...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../c5_niosii_spi_slvsec.sopcinfo
...
# CPU Name 
# setting CPU_NAME is niosii_cpu_nios2_gen2_0
CPU_NAME = niosii_cpu_nios2_gen2_0
...
# Design Name 
# setting SOPC_NAME is c5_niosii_spi_slvsec
SOPC_NAME := c5_niosii_spi_slvsec
...
# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1568412196
SOPC_SYSID_FLAG += --timestamp=1568412196
ELF_PATCH_FLAG  += --timestamp 1568412196
...
# setting hal.stderr is niosii_cpu_jtag_uart_0
ELF_PATCH_FLAG  += --stderr_dev niosii_cpu_jtag_uart_0

# Slave descriptor of STDIN character-mode device. This setting is used by the 
# ALT_STDIN family of defines in system.h. none 
# setting hal.stdin is niosii_cpu_jtag_uart_0
ELF_PATCH_FLAG  += --stdin_dev niosii_cpu_jtag_uart_0
...
# setting hal.stdout is niosii_cpu_jtag_uart_0
ELF_PATCH_FLAG  += --stdout_dev niosii_cpu_jtag_uart_0
