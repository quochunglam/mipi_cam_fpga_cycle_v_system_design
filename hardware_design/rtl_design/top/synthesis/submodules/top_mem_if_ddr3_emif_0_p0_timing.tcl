...
# Board skews
set board(abs_max_CK_delay) 0.307845356
set board(abs_max_DQS_delay) 0.203650039
set board(minCK_DQS_skew) 0.1041954
set board(maxCK_DQS_skew) 0.1595076
set board(tpd_inter_DIMM) 0.0
set board(intra_DQS_group_skew) 0.015848394
set board(inter_DQS_group_skew) 0.055954396
set board(DQ_DQS_skew) -0.003747657
set board(intra_addr_ctrl_skew) 0.017840331
set board(addresscmd_CK_skew) -0.001076354
