...
module top_mm_interconnect_3 (
		...
		output wire [24:0] sdram_vfb_s1_address,                                    //                                      sdram_vfb_s1.address
		output wire        sdram_vfb_s1_write,                                      //                                                  .write
		output wire        sdram_vfb_s1_read,                                       //                                                  .read
		input  wire [15:0] sdram_vfb_s1_readdata,                                   //                                                  .readdata
		output wire [15:0] sdram_vfb_s1_writedata,                                  //                                                  .writedata
		output wire [1:0]  sdram_vfb_s1_byteenable,                                 //                                                  .byteenable
		input  wire        sdram_vfb_s1_readdatavalid,                              //                                                  .readdatavalid
		input  wire        sdram_vfb_s1_waitrequest,                                //                                                  .waitrequest
		output wire        sdram_vfb_s1_chipselect                                  //                                                  .chipselect
	);
	...
	wire  [106:0] rsp_mux_src_data;                                                                  // rsp_mux:src_data -> alt_vip_cl_vfb_0_mem_master_rd_agent:rp_data
	...
	wire  [106:0] rsp_mux_001_src_data;                                                              // rsp_mux_001:src_data -> alt_vip_cl_vfb_0_mem_master_wr_agent:rp_data
	...
	wire   [15:0] sdram_vfb_s1_agent_m0_readdata;                                                    // sdram_vfb_s1_translator:uav_readdata -> sdram_vfb_s1_agent:m0_readdata
	wire          sdram_vfb_s1_agent_m0_waitrequest;                                                 // sdram_vfb_s1_translator:uav_waitrequest -> sdram_vfb_s1_agent:m0_waitrequest
	wire          sdram_vfb_s1_agent_m0_debugaccess;                                                 // sdram_vfb_s1_agent:m0_debugaccess -> sdram_vfb_s1_translator:uav_debugaccess
	wire   [31:0] sdram_vfb_s1_agent_m0_address;                                                     // sdram_vfb_s1_agent:m0_address -> sdram_vfb_s1_translator:uav_address
	wire    [1:0] sdram_vfb_s1_agent_m0_byteenable;                                                  // sdram_vfb_s1_agent:m0_byteenable -> sdram_vfb_s1_translator:uav_byteenable
	wire          sdram_vfb_s1_agent_m0_read;                                                        // sdram_vfb_s1_agent:m0_read -> sdram_vfb_s1_translator:uav_read
	wire          sdram_vfb_s1_agent_m0_readdatavalid;                                               // sdram_vfb_s1_translator:uav_readdatavalid -> sdram_vfb_s1_agent:m0_readdatavalid
	wire          sdram_vfb_s1_agent_m0_lock;                                                        // sdram_vfb_s1_agent:m0_lock -> sdram_vfb_s1_translator:uav_lock
	wire   [15:0] sdram_vfb_s1_agent_m0_writedata;                                                   // sdram_vfb_s1_agent:m0_writedata -> sdram_vfb_s1_translator:uav_writedata
	wire          sdram_vfb_s1_agent_m0_write;                                                       // sdram_vfb_s1_agent:m0_write -> sdram_vfb_s1_translator:uav_write
	wire    [1:0] sdram_vfb_s1_agent_m0_burstcount;                                                  // sdram_vfb_s1_agent:m0_burstcount -> sdram_vfb_s1_translator:uav_burstcount
	wire          sdram_vfb_s1_agent_rf_source_valid;                                                // sdram_vfb_s1_agent:rf_source_valid -> sdram_vfb_s1_agent_rsp_fifo:in_valid
	wire   [89:0] sdram_vfb_s1_agent_rf_source_data;                                                 // sdram_vfb_s1_agent:rf_source_data -> sdram_vfb_s1_agent_rsp_fifo:in_data
	wire          sdram_vfb_s1_agent_rf_source_ready;                                                // sdram_vfb_s1_agent_rsp_fifo:in_ready -> sdram_vfb_s1_agent:rf_source_ready
	wire          sdram_vfb_s1_agent_rf_source_startofpacket;                                        // sdram_vfb_s1_agent:rf_source_startofpacket -> sdram_vfb_s1_agent_rsp_fifo:in_startofpacket
	wire          sdram_vfb_s1_agent_rf_source_endofpacket;                                          // sdram_vfb_s1_agent:rf_source_endofpacket -> sdram_vfb_s1_agent_rsp_fifo:in_endofpacket
	wire          sdram_vfb_s1_agent_rsp_fifo_out_valid;                                             // sdram_vfb_s1_agent_rsp_fifo:out_valid -> sdram_vfb_s1_agent:rf_sink_valid
	wire   [89:0] sdram_vfb_s1_agent_rsp_fifo_out_data;                                              // sdram_vfb_s1_agent_rsp_fifo:out_data -> sdram_vfb_s1_agent:rf_sink_data
	wire          sdram_vfb_s1_agent_rsp_fifo_out_ready;                                             // sdram_vfb_s1_agent:rf_sink_ready -> sdram_vfb_s1_agent_rsp_fifo:out_ready
	wire          sdram_vfb_s1_agent_rsp_fifo_out_startofpacket;                                     // sdram_vfb_s1_agent_rsp_fifo:out_startofpacket -> sdram_vfb_s1_agent:rf_sink_startofpacket
	wire          sdram_vfb_s1_agent_rsp_fifo_out_endofpacket;                                       // sdram_vfb_s1_agent_rsp_fifo:out_endofpacket -> sdram_vfb_s1_agent:rf_sink_endofpacket
	wire          sdram_vfb_s1_agent_rdata_fifo_src_valid;                                           // sdram_vfb_s1_agent:rdata_fifo_src_valid -> sdram_vfb_s1_agent_rdata_fifo:in_valid
	wire   [17:0] sdram_vfb_s1_agent_rdata_fifo_src_data;                                            // sdram_vfb_s1_agent:rdata_fifo_src_data -> sdram_vfb_s1_agent_rdata_fifo:in_data
	wire          sdram_vfb_s1_agent_rdata_fifo_src_ready;                                           // sdram_vfb_s1_agent_rdata_fifo:in_ready -> sdram_vfb_s1_agent:rdata_fifo_src_ready
	wire          alt_vip_cl_vfb_0_mem_master_rd_agent_cp_valid;                                     // alt_vip_cl_vfb_0_mem_master_rd_agent:cp_valid -> router:sink_valid
	wire  [106:0] alt_vip_cl_vfb_0_mem_master_rd_agent_cp_data;                                      // alt_vip_cl_vfb_0_mem_master_rd_agent:cp_data -> router:sink_data
	...
	wire  [106:0] alt_vip_cl_vfb_0_mem_master_wr_agent_cp_data;                                      // alt_vip_cl_vfb_0_mem_master_wr_agent:cp_data -> router_001:sink_data
	...
	wire          router_002_src_valid;                                                              // router_002:src_valid -> sdram_vfb_s1_rsp_width_adapter:in_valid
	wire   [88:0] router_002_src_data;                                                               // router_002:src_data -> sdram_vfb_s1_rsp_width_adapter:in_data
	wire          router_002_src_ready;                                                              // sdram_vfb_s1_rsp_width_adapter:in_ready -> router_002:src_ready
	wire    [1:0] router_002_src_channel;                                                            // router_002:src_channel -> sdram_vfb_s1_rsp_width_adapter:in_channel
	wire          router_002_src_startofpacket;                                                      // router_002:src_startofpacket -> sdram_vfb_s1_rsp_width_adapter:in_startofpacket
	wire          router_002_src_endofpacket;                                                        // router_002:src_endofpacket -> sdram_vfb_s1_rsp_width_adapter:in_endofpacket
	wire          sdram_vfb_s1_rsp_width_adapter_src_valid;                                          // sdram_vfb_s1_rsp_width_adapter:out_valid -> rsp_demux:sink_valid
	wire  [106:0] sdram_vfb_s1_rsp_width_adapter_src_data;                                           // sdram_vfb_s1_rsp_width_adapter:out_data -> rsp_demux:sink_data
	wire          sdram_vfb_s1_rsp_width_adapter_src_ready;                                          // rsp_demux:sink_ready -> sdram_vfb_s1_rsp_width_adapter:out_ready
	wire    [1:0] sdram_vfb_s1_rsp_width_adapter_src_channel;                                        // sdram_vfb_s1_rsp_width_adapter:out_channel -> rsp_demux:sink_channel
	wire          sdram_vfb_s1_rsp_width_adapter_src_startofpacket;                                  // sdram_vfb_s1_rsp_width_adapter:out_startofpacket -> rsp_demux:sink_startofpacket
	wire          sdram_vfb_s1_rsp_width_adapter_src_endofpacket;                                    // sdram_vfb_s1_rsp_width_adapter:out_endofpacket -> rsp_demux:sink_endofpacket
	wire          cmd_mux_src_valid;                                                                 // cmd_mux:src_valid -> sdram_vfb_s1_cmd_width_adapter:in_valid
	wire  [106:0] cmd_mux_src_data;                                                                  // cmd_mux:src_data -> sdram_vfb_s1_cmd_width_adapter:in_data
	wire          cmd_mux_src_ready;                                                                 // sdram_vfb_s1_cmd_width_adapter:in_ready -> cmd_mux:src_ready
	wire    [1:0] cmd_mux_src_channel;                                                               // cmd_mux:src_channel -> sdram_vfb_s1_cmd_width_adapter:in_channel
	wire          cmd_mux_src_startofpacket;                                                         // cmd_mux:src_startofpacket -> sdram_vfb_s1_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_src_endofpacket;                                                           // cmd_mux:src_endofpacket -> sdram_vfb_s1_cmd_width_adapter:in_endofpacket
	wire          sdram_vfb_s1_cmd_width_adapter_src_valid;                                          // sdram_vfb_s1_cmd_width_adapter:out_valid -> sdram_vfb_s1_burst_adapter:sink0_valid
	wire   [88:0] sdram_vfb_s1_cmd_width_adapter_src_data;                                           // sdram_vfb_s1_cmd_width_adapter:out_data -> sdram_vfb_s1_burst_adapter:sink0_data
	wire          sdram_vfb_s1_cmd_width_adapter_src_ready;                                          // sdram_vfb_s1_burst_adapter:sink0_ready -> sdram_vfb_s1_cmd_width_adapter:out_ready
	wire    [1:0] sdram_vfb_s1_cmd_width_adapter_src_channel;                                        // sdram_vfb_s1_cmd_width_adapter:out_channel -> sdram_vfb_s1_burst_adapter:sink0_channel
	wire          sdram_vfb_s1_cmd_width_adapter_src_startofpacket;                                  // sdram_vfb_s1_cmd_width_adapter:out_startofpacket -> sdram_vfb_s1_burst_adapter:sink0_startofpacket
	wire          sdram_vfb_s1_cmd_width_adapter_src_endofpacket;                                    // sdram_vfb_s1_cmd_width_adapter:out_endofpacket -> sdram_vfb_s1_burst_adapter:sink0_endofpacket
	wire          sdram_vfb_s1_burst_adapter_source0_valid;                                          // sdram_vfb_s1_burst_adapter:source0_valid -> agent_pipeline:in_valid
	wire   [88:0] sdram_vfb_s1_burst_adapter_source0_data;                                           // sdram_vfb_s1_burst_adapter:source0_data -> agent_pipeline:in_data
	wire          sdram_vfb_s1_burst_adapter_source0_ready;                                          // agent_pipeline:in_ready -> sdram_vfb_s1_burst_adapter:source0_ready
	wire    [1:0] sdram_vfb_s1_burst_adapter_source0_channel;                                        // sdram_vfb_s1_burst_adapter:source0_channel -> agent_pipeline:in_channel
	wire          sdram_vfb_s1_burst_adapter_source0_startofpacket;                                  // sdram_vfb_s1_burst_adapter:source0_startofpacket -> agent_pipeline:in_startofpacket
	wire          sdram_vfb_s1_burst_adapter_source0_endofpacket;                                    // sdram_vfb_s1_burst_adapter:source0_endofpacket -> agent_pipeline:in_endofpacket
	wire          agent_pipeline_source0_valid;                                                      // agent_pipeline:out_valid -> sdram_vfb_s1_agent:cp_valid
	wire   [88:0] agent_pipeline_source0_data;                                                       // agent_pipeline:out_data -> sdram_vfb_s1_agent:cp_data
	wire          agent_pipeline_source0_ready;                                                      // sdram_vfb_s1_agent:cp_ready -> agent_pipeline:out_ready
	wire    [1:0] agent_pipeline_source0_channel;                                                    // agent_pipeline:out_channel -> sdram_vfb_s1_agent:cp_channel
	wire          agent_pipeline_source0_startofpacket;                                              // agent_pipeline:out_startofpacket -> sdram_vfb_s1_agent:cp_startofpacket
	wire          agent_pipeline_source0_endofpacket;                                                // agent_pipeline:out_endofpacket -> sdram_vfb_s1_agent:cp_endofpacket
	wire          sdram_vfb_s1_agent_rp_valid;                                                       // sdram_vfb_s1_agent:rp_valid -> agent_pipeline_001:in_valid
	wire   [88:0] sdram_vfb_s1_agent_rp_data;                                                        // sdram_vfb_s1_agent:rp_data -> agent_pipeline_001:in_data
	wire          sdram_vfb_s1_agent_rp_ready;                                                       // agent_pipeline_001:in_ready -> sdram_vfb_s1_agent:rp_ready
	wire          sdram_vfb_s1_agent_rp_startofpacket;                                               // sdram_vfb_s1_agent:rp_startofpacket -> agent_pipeline_001:in_startofpacket
	wire          sdram_vfb_s1_agent_rp_endofpacket;                                                 // sdram_vfb_s1_agent:rp_endofpacket -> agent_pipeline_001:in_endofpacket
	wire          agent_pipeline_001_source0_valid;                                                  // agent_pipeline_001:out_valid -> router_002:sink_valid
	wire   [88:0] agent_pipeline_001_source0_data;                                                   // agent_pipeline_001:out_data -> router_002:sink_data
	...
	wire  [106:0] cmd_demux_001_src0_data;                                                           // cmd_demux_001:src0_data -> mux_pipeline_001:in_data
	...
	wire  [106:0] mux_pipeline_001_source0_data;                                                     // mux_pipeline_001:out_data -> cmd_mux:sink1_data
	...
	wire  [106:0] rsp_demux_src0_data;                                                               // rsp_demux:src0_data -> mux_pipeline_002:in_data
	...
	wire  [106:0] mux_pipeline_002_source0_data;                                                     // mux_pipeline_002:out_data -> rsp_mux:sink0_data
	...
	wire  [106:0] rsp_demux_src1_data;                                                               // rsp_demux:src1_data -> mux_pipeline_003:in_data
	...
	wire  [106:0] mux_pipeline_003_source0_data;                                                     // mux_pipeline_003:out_data -> rsp_mux_001:sink0_data
	...
	wire          sdram_vfb_s1_agent_rdata_fifo_out_valid;                                           // sdram_vfb_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter:in_0_valid
	wire   [17:0] sdram_vfb_s1_agent_rdata_fifo_out_data;                                            // sdram_vfb_s1_agent_rdata_fifo:out_data -> avalon_st_adapter:in_0_data
	wire          sdram_vfb_s1_agent_rdata_fifo_out_ready;                                           // avalon_st_adapter:in_0_ready -> sdram_vfb_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_out_0_valid;                                                     // avalon_st_adapter:out_0_valid -> sdram_vfb_s1_agent:rdata_fifo_sink_valid
	wire   [17:0] avalon_st_adapter_out_0_data;                                                      // avalon_st_adapter:out_0_data -> sdram_vfb_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_out_0_ready;                                                     // sdram_vfb_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter:out_0_ready
	wire    [0:0] avalon_st_adapter_out_0_error;                                                     // avalon_st_adapter:out_0_error -> sdram_vfb_s1_agent:rdata_fifo_sink_error
	...
	) sdram_vfb_s1_translator (
		.clk                    (pll_0_outclk0_clk),                                       //                      clk.clk
		.reset                  (alt_vip_cl_vfb_0_main_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (sdram_vfb_s1_agent_m0_address),                           // avalon_universal_slave_0.address
		.uav_burstcount         (sdram_vfb_s1_agent_m0_burstcount),                        //                         .burstcount
		.uav_read               (sdram_vfb_s1_agent_m0_read),                              //                         .read
		.uav_write              (sdram_vfb_s1_agent_m0_write),                             //                         .write
		.uav_waitrequest        (sdram_vfb_s1_agent_m0_waitrequest),                       //                         .waitrequest
		.uav_readdatavalid      (sdram_vfb_s1_agent_m0_readdatavalid),                     //                         .readdatavalid
		.uav_byteenable         (sdram_vfb_s1_agent_m0_byteenable),                        //                         .byteenable
		.uav_readdata           (sdram_vfb_s1_agent_m0_readdata),                          //                         .readdata
		.uav_writedata          (sdram_vfb_s1_agent_m0_writedata),                         //                         .writedata
		.uav_lock               (sdram_vfb_s1_agent_m0_lock),                              //                         .lock
		.uav_debugaccess        (sdram_vfb_s1_agent_m0_debugaccess),                       //                         .debugaccess
		.av_address             (sdram_vfb_s1_address),                                    //      avalon_anti_slave_0.address
		.av_write               (sdram_vfb_s1_write),                                      //                         .write
		.av_read                (sdram_vfb_s1_read),                                       //                         .read
		.av_readdata            (sdram_vfb_s1_readdata),                                   //                         .readdata
		.av_writedata           (sdram_vfb_s1_writedata),                                  //                         .writedata
		.av_byteenable          (sdram_vfb_s1_byteenable),                                 //                         .byteenable
		.av_readdatavalid       (sdram_vfb_s1_readdatavalid),                              //                         .readdatavalid
		.av_waitrequest         (sdram_vfb_s1_waitrequest),                                //                         .waitrequest
		.av_chipselect          (sdram_vfb_s1_chipselect),                                 //                         .chipselect
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (pll_0_outclk0_clk),                                       //             clk.clk
		.reset                   (alt_vip_cl_vfb_0_main_reset_reset_bridge_in_reset_reset), //       clk_reset.reset
		.m0_address              (sdram_vfb_s1_agent_m0_address),                           //              m0.address
		.m0_burstcount           (sdram_vfb_s1_agent_m0_burstcount),                        //                .burstcount
		.m0_byteenable           (sdram_vfb_s1_agent_m0_byteenable),                        //                .byteenable
		.m0_debugaccess          (sdram_vfb_s1_agent_m0_debugaccess),                       //                .debugaccess
		.m0_lock                 (sdram_vfb_s1_agent_m0_lock),                              //                .lock
		.m0_readdata             (sdram_vfb_s1_agent_m0_readdata),                          //                .readdata
		.m0_readdatavalid        (sdram_vfb_s1_agent_m0_readdatavalid),                     //                .readdatavalid
		.m0_read                 (sdram_vfb_s1_agent_m0_read),                              //                .read
		.m0_waitrequest          (sdram_vfb_s1_agent_m0_waitrequest),                       //                .waitrequest
		.m0_writedata            (sdram_vfb_s1_agent_m0_writedata),                         //                .writedata
		.m0_write                (sdram_vfb_s1_agent_m0_write),                             //                .write
		.rp_endofpacket          (sdram_vfb_s1_agent_rp_endofpacket),                       //              rp.endofpacket
		.rp_ready                (sdram_vfb_s1_agent_rp_ready),                             //                .ready
		.rp_valid                (sdram_vfb_s1_agent_rp_valid),                             //                .valid
		.rp_data                 (sdram_vfb_s1_agent_rp_data),                              //                .data
		.rp_startofpacket        (sdram_vfb_s1_agent_rp_startofpacket),                     //                .startofpacket
		...
		.rf_sink_ready           (sdram_vfb_s1_agent_rsp_fifo_out_ready),                   //         rf_sink.ready
		.rf_sink_valid           (sdram_vfb_s1_agent_rsp_fifo_out_valid),                   //                .valid
		.rf_sink_startofpacket   (sdram_vfb_s1_agent_rsp_fifo_out_startofpacket),           //                .startofpacket
		.rf_sink_endofpacket     (sdram_vfb_s1_agent_rsp_fifo_out_endofpacket),             //                .endofpacket
		.rf_sink_data            (sdram_vfb_s1_agent_rsp_fifo_out_data),                    //                .data
		.rf_source_ready         (sdram_vfb_s1_agent_rf_source_ready),                      //       rf_source.ready
		.rf_source_valid         (sdram_vfb_s1_agent_rf_source_valid),                      //                .valid
		.rf_source_startofpacket (sdram_vfb_s1_agent_rf_source_startofpacket),              //                .startofpacket
		.rf_source_endofpacket   (sdram_vfb_s1_agent_rf_source_endofpacket),                //                .endofpacket
		.rf_source_data          (sdram_vfb_s1_agent_rf_source_data),                       //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_out_0_ready),                           // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_out_0_valid),                           //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_out_0_data),                            //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_out_0_error),                           //                .error
		.rdata_fifo_src_ready    (sdram_vfb_s1_agent_rdata_fifo_src_ready),                 //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (sdram_vfb_s1_agent_rdata_fifo_src_valid),                 //                .valid
		.rdata_fifo_src_data     (sdram_vfb_s1_agent_rdata_fifo_src_data),                  //                .data
	...
	) sdram_vfb_s1_agent_rsp_fifo (
		.clk               (pll_0_outclk0_clk),                                       //       clk.clk
		.reset             (alt_vip_cl_vfb_0_main_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (sdram_vfb_s1_agent_rf_source_data),                       //        in.data
		.in_valid          (sdram_vfb_s1_agent_rf_source_valid),                      //          .valid
		.in_ready          (sdram_vfb_s1_agent_rf_source_ready),                      //          .ready
		.in_startofpacket  (sdram_vfb_s1_agent_rf_source_startofpacket),              //          .startofpacket
		.in_endofpacket    (sdram_vfb_s1_agent_rf_source_endofpacket),                //          .endofpacket
		.out_data          (sdram_vfb_s1_agent_rsp_fifo_out_data),                    //       out.data
		.out_valid         (sdram_vfb_s1_agent_rsp_fifo_out_valid),                   //          .valid
		.out_ready         (sdram_vfb_s1_agent_rsp_fifo_out_ready),                   //          .ready
		.out_startofpacket (sdram_vfb_s1_agent_rsp_fifo_out_startofpacket),           //          .startofpacket
		.out_endofpacket   (sdram_vfb_s1_agent_rsp_fifo_out_endofpacket),             //          .endofpacket
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) sdram_vfb_s1_agent_rdata_fifo (
		.clk               (pll_0_outclk0_clk),                                       //       clk.clk
		.reset             (alt_vip_cl_vfb_0_main_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (sdram_vfb_s1_agent_rdata_fifo_src_data),                  //        in.data
		.in_valid          (sdram_vfb_s1_agent_rdata_fifo_src_valid),                 //          .valid
		.in_ready          (sdram_vfb_s1_agent_rdata_fifo_src_ready),                 //          .ready
		.out_data          (sdram_vfb_s1_agent_rdata_fifo_out_data),                  //       out.data
		.out_valid         (sdram_vfb_s1_agent_rdata_fifo_out_valid),                 //          .valid
		.out_ready         (sdram_vfb_s1_agent_rdata_fifo_out_ready),                 //          .ready
		.csr_address       (2'b00),                                                   // (terminated)
		.csr_read          (1'b0),                                                    // (terminated)
		.csr_write         (1'b0),                                                    // (terminated)
		.csr_readdata      (),                                                        // (terminated)
	...
	) sdram_vfb_s1_burst_adapter (
		.clk                   (pll_0_outclk0_clk),                                       //       cr0.clk
		.reset                 (alt_vip_cl_vfb_0_main_reset_reset_bridge_in_reset_reset), // cr0_reset.reset
		.sink0_valid           (sdram_vfb_s1_cmd_width_adapter_src_valid),                //     sink0.valid
		.sink0_data            (sdram_vfb_s1_cmd_width_adapter_src_data),                 //          .data
		.sink0_channel         (sdram_vfb_s1_cmd_width_adapter_src_channel),              //          .channel
		.sink0_startofpacket   (sdram_vfb_s1_cmd_width_adapter_src_startofpacket),        //          .startofpacket
		.sink0_endofpacket     (sdram_vfb_s1_cmd_width_adapter_src_endofpacket),          //          .endofpacket
		.sink0_ready           (sdram_vfb_s1_cmd_width_adapter_src_ready),                //          .ready
		.source0_valid         (sdram_vfb_s1_burst_adapter_source0_valid),                //   source0.valid
		.source0_data          (sdram_vfb_s1_burst_adapter_source0_data),                 //          .data
		.source0_channel       (sdram_vfb_s1_burst_adapter_source0_channel),              //          .channel
		.source0_startofpacket (sdram_vfb_s1_burst_adapter_source0_startofpacket),        //          .startofpacket
		.source0_endofpacket   (sdram_vfb_s1_burst_adapter_source0_endofpacket),          //          .endofpacket
		.source0_ready         (sdram_vfb_s1_burst_adapter_source0_ready)                 //          .ready
	);
	...
	top_mm_interconnect_3_rsp_demux rsp_demux (
		.clk                (pll_0_outclk0_clk),                                       //       clk.clk
		.reset              (alt_vip_cl_vfb_0_main_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.sink_ready         (sdram_vfb_s1_rsp_width_adapter_src_ready),                //      sink.ready
		.sink_channel       (sdram_vfb_s1_rsp_width_adapter_src_channel),              //          .channel
		.sink_data          (sdram_vfb_s1_rsp_width_adapter_src_data),                 //          .data
		.sink_startofpacket (sdram_vfb_s1_rsp_width_adapter_src_startofpacket),        //          .startofpacket
		.sink_endofpacket   (sdram_vfb_s1_rsp_width_adapter_src_endofpacket),          //          .endofpacket
		.sink_valid         (sdram_vfb_s1_rsp_width_adapter_src_valid),                //          .valid
	...
	altera_merlin_width_adapter #(
	...
	) sdram_vfb_s1_rsp_width_adapter (
		.clk                  (pll_0_outclk0_clk),                                       //       clk.clk
		.reset                (alt_vip_cl_vfb_0_main_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		...
		.out_endofpacket      (sdram_vfb_s1_rsp_width_adapter_src_endofpacket),          //       src.endofpacket
		.out_data             (sdram_vfb_s1_rsp_width_adapter_src_data),                 //          .data
		.out_channel          (sdram_vfb_s1_rsp_width_adapter_src_channel),              //          .channel
		.out_valid            (sdram_vfb_s1_rsp_width_adapter_src_valid),                //          .valid
		.out_ready            (sdram_vfb_s1_rsp_width_adapter_src_ready),                //          .ready
		.out_startofpacket    (sdram_vfb_s1_rsp_width_adapter_src_startofpacket),        //          .startofpacket
	...
	altera_merlin_width_adapter #(
		...
		.PACKING                       (1),
		.ENABLE_ADDRESS_ALIGNMENT      (0)
	) sdram_vfb_s1_cmd_width_adapter (
		.clk                  (pll_0_outclk0_clk),                                       //       clk.clk
		.reset                (alt_vip_cl_vfb_0_main_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		...
		.out_endofpacket      (sdram_vfb_s1_cmd_width_adapter_src_endofpacket),          //       src.endofpacket
		.out_data             (sdram_vfb_s1_cmd_width_adapter_src_data),                 //          .data
		.out_channel          (sdram_vfb_s1_cmd_width_adapter_src_channel),              //          .channel
		.out_valid            (sdram_vfb_s1_cmd_width_adapter_src_valid),                //          .valid
		.out_ready            (sdram_vfb_s1_cmd_width_adapter_src_ready),                //          .ready
		.out_startofpacket    (sdram_vfb_s1_cmd_width_adapter_src_startofpacket),        //          .startofpacket
		.in_command_size_data (3'b000)                                                   // (terminated)
	);
	...
	altera_avalon_st_pipeline_stage #(
		...
		.clk               (pll_0_outclk0_clk),                                       //       cr0.clk
		.reset             (alt_vip_cl_vfb_0_main_reset_reset_bridge_in_reset_reset), // cr0_reset.reset
		.in_ready          (sdram_vfb_s1_burst_adapter_source0_ready),                //     sink0.ready
		.in_valid          (sdram_vfb_s1_burst_adapter_source0_valid),                //          .valid
		.in_startofpacket  (sdram_vfb_s1_burst_adapter_source0_startofpacket),        //          .startofpacket
		.in_endofpacket    (sdram_vfb_s1_burst_adapter_source0_endofpacket),          //          .endofpacket
		.in_data           (sdram_vfb_s1_burst_adapter_source0_data),                 //          .data
		.in_channel        (sdram_vfb_s1_burst_adapter_source0_channel),              //          .channel
	...
	altera_avalon_st_pipeline_stage #(
		...
		.clk               (pll_0_outclk0_clk),                                       //       cr0.clk
		.reset             (alt_vip_cl_vfb_0_main_reset_reset_bridge_in_reset_reset), // cr0_reset.reset
		.in_ready          (sdram_vfb_s1_agent_rp_ready),                             //     sink0.ready
		.in_valid          (sdram_vfb_s1_agent_rp_valid),                             //          .valid
		.in_startofpacket  (sdram_vfb_s1_agent_rp_startofpacket),                     //          .startofpacket
		.in_endofpacket    (sdram_vfb_s1_agent_rp_endofpacket),                       //          .endofpacket
		.in_data           (sdram_vfb_s1_agent_rp_data),                              //          .data
	...
	top_mm_interconnect_3_avalon_st_adapter #(
		...
		.in_0_data      (sdram_vfb_s1_agent_rdata_fifo_out_data),                  //     in_0.data
		.in_0_valid     (sdram_vfb_s1_agent_rdata_fifo_out_valid),                 //         .valid
		.in_0_ready     (sdram_vfb_s1_agent_rdata_fifo_out_ready),                 //         .ready
