...
# Memory: csr_regmap
MEM_0 := top_csr_regmap
$(MEM_0)_NAME := csr_regmap
...
$(MEM_0)_START := 0x40081000
$(MEM_0)_END := 0x4008101f
$(MEM_0)_SPAN := 0x00000020
$(MEM_0)_HIERARCHICAL_PATH := csr_regmap
$(MEM_0)_WIDTH := 32
...
.PHONY: csr_regmap
csr_regmap: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym
...
$(MEM_2)_START := 0x40060000
$(MEM_2)_END := 0x4007ffff
$(MEM_2)_SPAN := 0x00020000
$(MEM_2)_HIERARCHICAL_PATH := nios_ram
$(MEM_2)_WIDTH := 32
...
.PHONY: nios_ram
nios_ram: check_elf_exists $(MEM_INIT_DIR)/$(MEM_2).hex $(HDL_SIM_DIR)/$(MEM_2).dat $(HDL_SIM_DIR)/$(MEM_2).sym

# Memory: ocm_256k_dma
MEM_3 := top_ocm_256k_dma
$(MEM_3)_NAME := ocm_256k_dma
...
$(MEM_3)_END := 0x4003ffff
$(MEM_3)_SPAN := 0x00040000
$(MEM_3)_HIERARCHICAL_PATH := ocm_256k_dma
$(MEM_3)_WIDTH := 32
...
.PHONY: ocm_256k_dma
ocm_256k_dma: check_elf_exists $(MEM_INIT_DIR)/$(MEM_3).hex $(HDL_SIM_DIR)/$(MEM_3).dat $(HDL_SIM_DIR)/$(MEM_3).sym
